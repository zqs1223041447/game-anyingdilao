...
public class SK_CP_Universe_Aixs : MonoBehaviour
{
	...
	public SK_CP_Universe_Ball ball;
	...
	public void BindBall(SK_CP_Universe_Ball newBall, SK_CP_Universe newFather)
	{
		ball = newBall;
		father = newFather;
		CanZhuan = true;
